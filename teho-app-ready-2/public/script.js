...
// ==========================================
// СЕКРЕТНЫЙ ВХОД В БЭК-ОФИС
// Админка доступна только по ссылке вида:  https://ваш-сайт/#teho-office-2026
// Обычные посетители кнопки входа не видят.
// ==========================================
...
const Admin = {
    ...
    async renderDashboard() {
        const [ordersRes, tablesRes, reviewsRes, appsRes] = await Promise.all([
